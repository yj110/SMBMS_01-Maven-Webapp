...
<div class="right">
        ...
        <div class="providerAdd">
           <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/jsp/addProcider.do" enctype="multipart/form-data">
			<!-- <input type="hidden" name="method" value="add"> -->
                ...
                <div>
                 ...
                 <div>
                    ...
                    <input type="file" name="photos" id="a_workPicPath" value="">
                    <font color="red">${errors }</font> 
                </div>
                <div>
                    <label for="a_orgaPicPath">组织机构代码证：</label>
                    <input type="file" name="photos" id="a_orgaPicPath" value=""> 
                    <font color="red">${errors }</font> 
                </div>
